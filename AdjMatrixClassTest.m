classdef AdjMatrixClassTest < matlab.unittest.TestCase
    ...
    properties (TestParameter) %% parameters that will be used in test methods
        ...
        squareMatrixAdjungate = struct('squareMatrixAdjungate1',[5 -3; -2 1],'squareMatrixAdjungate2',[0 1 -1; -8 4 4; 16 -6 -2]);
        %% scalars
        scalars = struct('scalar1',1,'scalar2',3,'scalar3',4,'scalar4',6,'scalar5',-1);
        scalarAdjungate = struct('scalarAdjungate',1)
    ...
    methods (Test, ParameterCombination = 'sequential')
        function testAdjungSquareMatrix(testCase, squareMatrixes,squareMatrixAdjungate)
            actualSolution = adjMatrix(squareMatrixes);
            expectedSolution = squareMatrixAdjungate;
